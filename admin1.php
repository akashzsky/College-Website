...
if((!empty($_POST["password"])) and (!empty($_POST["id"]))and !strcmp($id,"admin") and !strcmp($password,"password"))
{
...
<h3 style = "color:green;font-size:200%;">Admin Login</h3>
<p><span class="error">* required field.</span></p>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  

  Admin User Id: <input type="text" name="id" value="<?php echo $id;?>">
