...
$name=$_POST['S_Name'];
$age=$_POST['S_Age'];
$cn=$_POST['S_ContactNumber'];
$roll=$_POST['S_Roll'];
$pass=$_POST['Password'];
//echo $name,$roll,$age,$cn,$pass,$id;
$con=new mySqli("localhost","root","","college_database");
if(!$con)
{
die('could not connect try again :'.mysql_error());
}
$sql = "INSERT INTO UserProfile(NAME,Password,Age,Contact,RollNo)
VALUES ('$_POST[S_Name]','$_POST[Password]','$_POST[S_Age]','$_POST[S_ContactNumber]','$_POST[S_Roll]')";
