...
$sql="select * from results r inner join userprofile up on r.StudentID=up.ID where up.RollNo=$id";
...
<td style = \"background-color: #ccc;\"><b>CGPA</b></td></tr>
<tr><td>".$rows["RollNo"]."</td><td>".$rows["NAME"]."</td><td>".$rows["Marks"]."</td></tr></table>";
}
else
{
	echo "Roll Number do not exist!
	<br>
	<a href=\"result.php\"><b>GO BACK</b></a>";
}
?>  
</article>
