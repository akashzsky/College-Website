...
<h3 style = "color:green;font-size:200%;" align="center">Student Registration</h3>
<!--p><span class="error">* required field.</span></p-->
<form method="post" action="register.php"> <center>
<table>
<!--<tr><td>Student Id</td><td><input type="text"name="S_Id"></td></tr>-->
<tr><td>Student Name</td><td><input type="text"name="S_Name"required></td></tr>
<tr><td>Age</td><td><input type="text"name="S_Age"required></td></tr>
<tr><td>Roll Number</td><td><input type="text"name="S_Roll"required></td></tr>
<tr><td>Contact Number</td><td><input type="text"name="S_ContactNumber"required></td></tr>
